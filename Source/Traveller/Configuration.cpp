...
std::shared_ptr<Configuration> Configuration::getByName(const std::string &name, const ini::parsed_data& defaults){
    ...
    auto parser = std::make_unique<ini::parser<ini::comment_char::hash_tag>>(path.string());
...
std::string Configuration::getEntry(const std::string &section, const std::string &name) {
...
void Configuration::addEntry(const std::string &section, const std::string &entry, const std::string &value) {
